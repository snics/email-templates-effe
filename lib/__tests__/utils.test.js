...
describe('utils', () => {
  describe('loadFiles', () => {
    it('should display an empty array by not found files', () => {
      const files = utils.loadFiles(path.join(__dirname, 'files/no-files'), '**/*.js');
    ...
    it('should display an array of files locations', () => {
      const files = utils.loadFiles(path.join(__dirname, 'files/js-files'), '**/*.js');
    ...
    it('should display an array of files locations for multiple inputs', () => {
      const one = path.join(__dirname, 'files/no-files');
      const two = path.join(__dirname, 'files/js-files');
